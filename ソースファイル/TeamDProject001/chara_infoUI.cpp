...
// 情報の設定処理
//========================
void CCharaInfoUI::SetData(const D3DXVECTOR3& pos, const int nPlayerID, const TYPE type)
{
...
// 生成処理
//========================
CCharaInfoUI* CCharaInfoUI::Create(const D3DXVECTOR3& pos, const int nPlayerID, const TYPE type)
{
	// ローカルオブジェクトを生成
