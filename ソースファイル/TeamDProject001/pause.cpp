...
{
	nullptr,								// 背景ポリゴン
	"data\\TEXTURE\\PASUE　menu.png",			// ポーズメニューのテクスチャ
	"data\\TEXTURE\\PASUE　menu  return to game.png",		// コンティニューのテクスチャ
	"data\\TEXTURE\\PASUE　menu Reset.png",		// リセットのテクスチャ
	"data\\TEXTURE\\PASUE　menu taitle.png",		// タイトルのテクスチャ
};
